...
// Welcome show summary of current Gubet instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gubet JavaScript console!\n\n"

	// Print some generic Gubet metadata
